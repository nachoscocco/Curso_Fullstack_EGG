...
public class MenuOpciones {
    ...
    public void menu() throws Exception {
        ...
        do {
            ...
            System.out.println("10- Eliminar mascota puntual con ID");
            System.out.println(" 0- Salir");

            int opcion = sc.nextInt();
            switch (opcion) {
                case 1:
                    usuarioService.crearUsuario(cargarCorreo(), cargarClave(), cargarDni(), cargarFecha(), "ARGENTINA", "BSAS");
                    break;
                case 2:
                    mascotaService.cargarMascotaUsuario(cargarApodo(), cargarRaza(),ingresarIdUsuario());                    
                    break;
                case 3:
                ...
                case 9:
                    ...
                    break;
                case 10:
                    mascotaService.eliminarMascota(cargarIdMascot());
                    break;
                case 0:
                    System.exit(0);
                    break;
    ...
    public void limpiarPantalla() throws AWTException {
        //Dejo esre metodo para ir borrando la consola
