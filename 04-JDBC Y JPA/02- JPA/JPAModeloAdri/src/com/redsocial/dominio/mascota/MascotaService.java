...
public class MascotaService {
    ...
    public void cargarMascotaUsuario(String apodo, String raza,String idUsuario){
        try {
            //Validamos
            ...
            daoMascota.guardarMascota(mascota);
            daoUsuario.modificarUsuario(usuario);// Utilizo el metodo del DAO
        } catch (Exception e) {
            System.out.println(e.getMessage());
    }
    }
    public void eliminarMascota(String idMascotaElimi){
        try{
        daoMascota.eliminarMascota(idMascotaElimi);
        }catch (Exception e){
            System.out.println(e.getMessage());
        }
    }
            ...
            if (mascotas.isEmpty()) {
                ...
                for (Mascota u : mascotas) {
                    ...
                    System.out.println(" Apodo Mascota:" + u.getApodo()
                            ...
                            + "\n Correo Electronico Duenio:" + u.getDuenio().getCorreoElectronico());
                }
            }
        } catch (Exception e) {
            System.out.println(e.getMessage());
